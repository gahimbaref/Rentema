...
-- Email Workflow Tables (Migration 007)
...
CREATE INDEX IF NOT EXISTS idx_questionnaire_tokens_inquiry ON questionnaire_tokens(inquiry_id);
CREATE INDEX IF NOT EXISTS idx_questionnaire_tokens_token ON questionnaire_tokens(token);
CREATE INDEX IF NOT EXISTS idx_questionnaire_tokens_expires ON questionnaire_tokens(expires_at);
...
CREATE INDEX IF NOT EXISTS idx_sent_email_logs_inquiry ON sent_email_logs(inquiry_id);
CREATE INDEX IF NOT EXISTS idx_sent_email_logs_type ON sent_email_logs(email_type);
CREATE INDEX IF NOT EXISTS idx_sent_email_logs_sent_at ON sent_email_logs(sent_at);
...
CREATE INDEX IF NOT EXISTS idx_booking_tokens_inquiry ON booking_tokens(inquiry_id);
CREATE INDEX IF NOT EXISTS idx_booking_tokens_token ON booking_tokens(token);
CREATE INDEX IF NOT EXISTS idx_booking_tokens_slot_start ON booking_tokens(slot_start_time);
...
CREATE INDEX IF NOT EXISTS idx_email_templates_manager ON email_templates(manager_id);
CREATE INDEX IF NOT EXISTS idx_email_templates_type ON email_templates(template_type);
CREATE UNIQUE INDEX IF NOT EXISTS idx_email_templates_manager_type_default 
